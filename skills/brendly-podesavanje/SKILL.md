---
name: brendly-podesavanje
description: Povezivanje Brendly naloga sa Claude-om i rešavanje problema sa vezom - prvi put, posle instalacije plugina, i kad `brendly_*` alatke nema ili vraćaju grešku pristupa. Koristi za "poveži me sa Brendly-jem", "instalirao sam plugin šta sad", "ne vidim Brendly alatke", "traži mi ponovo prijavu", "izgubila se veza", "kako da se prijavim", i kad prvi poziv `brendly_context` padne na autorizaciji.
---
